...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Barthor server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Barthor features */
        {"barthor", "masternode", &masternode, true, true, false},
        {"barthor", "listmasternodes", &listmasternodes, true, true, false},
        {"barthor", "getmasternodecount", &getmasternodecount, true, true, false},
        {"barthor", "masternodeconnect", &masternodeconnect, true, true, false},
        {"barthor", "masternodecurrent", &masternodecurrent, true, true, false},
        {"barthor", "masternodedebug", &masternodedebug, true, true, false},
        {"barthor", "startmasternode", &startmasternode, true, true, false},
        {"barthor", "createmasternodekey", &createmasternodekey, true, true, false},
        {"barthor", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"barthor", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"barthor", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"barthor", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"barthor", "getmasternodescores", &getmasternodescores, true, true, false},
        {"barthor", "mnbudget", &mnbudget, true, true, false},
        {"barthor", "preparebudget", &preparebudget, true, true, false},
        {"barthor", "submitbudget", &submitbudget, true, true, false},
        {"barthor", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"barthor", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"barthor", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"barthor", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"barthor", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"barthor", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"barthor", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"barthor", "checkbudgets", &checkbudgets, true, true, false},
        {"barthor", "mnsync", &mnsync, true, true, false},
        {"barthor", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> barthor-cli " + methodname + " " + args + "\n";
}
