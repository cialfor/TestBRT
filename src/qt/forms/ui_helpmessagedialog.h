...
public:
    ...
    void setupUi(QDialog *HelpMessageDialog)
    {
        ...
        HelpMessageDialog->setWindowTitle(QStringLiteral("Barthor Core - Command-line options"));
        ...
        graphic->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 480, 212));
