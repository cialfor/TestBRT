...
/** Utility functions used by the Barthor Qt UI.
 */
namespace GUIUtil
{
...
// Render BRT addresses in monospace font
...
// Parse "barthor:" URI into recipient object, return true on successful parsing
