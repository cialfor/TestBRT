                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Barthor Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BRT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and barthor: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Barthor Core"), this);
    aboutAction->setStatusTip(tr("Show information about Barthor Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Barthor"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BRT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BRT addresses"));
    ...
    openAction->setStatusTip(tr("Open a barthor: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Barthor Core help message to get a list with possible Barthor command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Barthor Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Barthor network", "", count));
}
...
{
    QString strTitle = tr("Barthor Core"); // default title
