/* src/config/barthor-config.h.  Generated from barthor-config.h.in by configure.  */
/* src/config/barthor-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "Barthor Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Barthor Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "barthor"
