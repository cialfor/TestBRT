...
#if defined(NDEBUG)
#error "Barthor cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight < Params().LAST_POW_BLOCK())
        ...
        nSubsidy = 20 * COIN;
    else if (nHeight > 525000 && nHeight <= 1051200)
        nSubsidy = 18 * COIN;
    else if (nHeight > 1051200 && nHeight <= 1576200)
        nSubsidy = 16.2 * COIN;
    else if (nHeight > 1576200 && nHeight <= 2101200)
        nSubsidy = 14.58 * COIN;
    else if (nHeight > 2101200 && nHeight <= 2626200)
        nSubsidy = 13.122 * COIN;
    else if (nHeight > 2626200 && nHeight <= 3151200)
        nSubsidy = 11.81 * COIN;
    else
        nSubsidy = 10 * COIN;
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // BRT: We use certain sporks during IBD, so check to see if they are
