...
RESOURCES += src/qt/barthor.qrc src/qt/barthor_locale.qrc

TRANSLATIONS += src/qt/locale/barthor_bg.ts \
                src/qt/locale/barthor_de.ts \
                src/qt/locale/barthor_en.ts \
                src/qt/locale/barthor_es.ts \
                src/qt/locale/barthor_fi.ts \
                src/qt/locale/barthor_fr.ts \
                src/qt/locale/barthor_it.ts \
                src/qt/locale/barthor_ja.ts \
                src/qt/locale/barthor_pl.ts \
                src/qt/locale/barthor_pt.ts \
                src/qt/locale/barthor_ru.ts \
                src/qt/locale/barthor_sk.ts \
                src/qt/locale/barthor_sv.ts \
                src/qt/locale/barthor_vi.ts \
                src/qt/locale/barthor_zh_CN.ts \
                src/qt/locale/barthor_zh_TW.ts
