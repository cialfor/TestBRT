Contributing to Barthor Core
==================================

The Barthor Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Barthor Core project, and is not to be
confused with overall Barthor Network Protocol consensus changes.

Whether a pull request is merged into Barthor Core rests with the project merge
...
Patches that change Barthor consensus rules are considerably more involved than
...
Where a patch set proposes to change the Barthor consensus, it must have been
...
The project leader is the release manager for each Barthor Core release.
