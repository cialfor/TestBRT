...
This mechanism has been integrated into Bitcore-Node-Barthor which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/barthor/insight-api-barthor#web-socket-api](https://github.com/barthor/insight-api-barthor#web-socket-api)
* API: [https://github.com/barthor/insight-api-barthor#swifttx-transactions](https://github.com/barthor/insight-api-barthor#swifttx-transactions)
...
By default, the Barthor Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Barthor Core daemon:
