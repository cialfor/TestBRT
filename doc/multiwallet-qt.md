...
In order to support loading of multiple wallets in barthor-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is barthor.cpp.
...
Changes to barthor.cpp
----------------------
barthor.cpp is the entry point into barthor-qt, and as such, will require some minor modifications to provide hooks for
