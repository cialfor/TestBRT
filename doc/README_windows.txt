...
Intro
-----
Barthor (BRT) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Barthor utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run barthor-qt.exe.

Barthor Core is the original Barthor client and it builds the backbone of the network.
However, it downloads and stores the entire history of Barthor transactions;
