...
#   c) node1 mines 32 blocks, so now node 0 has 500000BRT, node 1 has 4250BRT, node2 has none.
#   d) node0 sends 601 BRT to node2, in two transactions (301 BRT, then 300 BRT).
